...
import { ColumnsToTabs, ColumnTab } from '../../components/ColumnsToTabs/ColumnsToTabs';
import LeaderDisplay from '../../components/LeaderDisplay/LeaderDisplay';
...
const LeaderboardScreen = () => {
  ...
  return (
    <div className="leaderboard-screen">
      <Container>
        <ColumnsToTabs columns={3} tabBreakpoint={850}>
